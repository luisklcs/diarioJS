...
require 'plugins/PHPMailer/src/SMTP.php';
            ...
            function sent_mail($addres,$cc,$suj,$data){
                ...
                try {
                    ...
                    $mail->Username   = 'estadosjudicialsincelejosucre@gmail.com';        // SMTP username
                    $mail->Password   = 'icphtklyqphawrqc';                   // SMTP password
                    ...
                    //Recipients
                    $mail->setFrom('estadosjudicialsincelejosucre@gmail.com', 'Diario Judicial Sincelejo, Sucre');
                    ...
                    if(!$mail->send()){
                            echo $agregado = "Pronto nos comunicaremos contigo.";
                    }
