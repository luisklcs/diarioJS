...
if (isset($_SESSION['user']) && $_SESSION['user']['rol'] = 1) {
    ...
    if (isset($_POST['accion'])) {
        ...
        switch ($_POST['accion']) {
            ...
            case 'editarcliente':
                $clientesController->editar($_POST['idCliente']);
                break;
        }
    }
...
?>
    ...
    <body class="g-sidenav-show  bg-gray-100">
        ...
        if (isset($_POST['accion']) && $_POST['accion'] == 'ActualizarVistasGenerales') {
        ...
        ?>
                <script>
                    ...
                    Swal.fire({
                        icon: 'success',
                        title: 'Actualizado!',
                        text: 'Vistas generales Actualizadas correctamente!',
                    })
                </script>
    <?php
            }
