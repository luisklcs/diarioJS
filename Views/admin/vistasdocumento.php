...
if (!isset($_SESSION['id'])) {
   header("location:clientes.php");
    ...
    $id = $_SESSION['id'];
  #  unset($_SESSION['id']);
$data = $controller->documentoVisualizado($id); 
                        ...
                        <div class="row">
                            <?php
                             if ($data == 0) {
                                ...
                                <h3 class="text-uppercase ">Este documento no tiene visualizaciones </h3>
                            ...
                            <div class="col-lg-6 col-7">
                                <h6 class="text-uppercase ">Lista de clientes que han visto el documento: <?php #$name = $data;$name = $name->fetch(PDO::FETCH_ASSOC);  echo $name['nombreUsuario']." ".$name['apellidos']  ?></h6>
                               
                                    <span class="font-weight-bold ms-1">
                                     
                                    </span>Este documento ha sido visualizado por <?php echo $data->rowCount();?> clientes <i class="fa fa-check text-info" aria-hidden="true"></i>
                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-center text-secondary text-xs font-weight-bold ps-2">Documento</th>
                                        <th class="text-uppercase text-center text-secondary text-xs font-weight-bold ps-2">fecha</th>
                                        <th class="text-uppercase text-center text-secondary text-xs font-weight-bold ps-2">Cliente</th>
                                        <th class="text-uppercase text-center text-secondary text-xs font-weight-bold ps-2">Usadas hoy</th>
                                        <th class="text-uppercase text-center text-secondary text-xs font-weight-bold ps-2">Total vistas</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="align-middle text-center text-sm  py-1">
                                                    <span class="text-uppercase text-xs font-weight-bold"><?php echo ($cliente['nombre']) ?></span>
                                                </div>
                                            </td>

                                            <td>
                                                <div class="align-middle text-center text-sm  py-1">
                                                    <span class=" text-xs font-weight-bold"><?php echo ($cliente['fecha']) ?></span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="align-middle text-center text-sm  py-1">
                                                    <span class="text-uppercase text-xs font-weight-bold"><?php echo ($cliente['nombreUsuario']." ".$cliente['apellidos']) ?></span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="align-middle text-center text-sm  py-1">
                                            ...
                                            <td>
                                                <div class="align-middle text-center text-sm  py-1">
                                                    <span class="text-uppercase text-xs font-weight-bold"><?php echo ($cliente['total_vistas_usadas']) ?></span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="align-middle text-center text-sm  py-1">
