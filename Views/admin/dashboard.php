...
$stmt2 = $dbh->query('SELECT COUNT(*) FROM usuarios WHERE `rol`=2');
$stmt3 = $dbh->query('SELECT COUNT(*) FROM `usuarios` WHERE `rol`=2 AND `estadoCuenta` = 1');
$stmt4 = $dbh->query('SELECT COUNT(*) FROM `usuarios` WHERE `estadoCuenta` = 0');
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                Dulcería la Gordy | Todos los derechos reservados. </div>
            </div>
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <p class="nav-link text-muted"> Creado por Pedro Banda </p>
