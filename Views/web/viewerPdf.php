      ...
      <div id="mainContainer">
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
          <div id="secondaryToolbarButtonContainer">
            ...
            <button id="secondaryPrint" class="secondaryToolbarButton visibleMediumView" title="Imprimir" tabindex="52" data-l10n-id="print">
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div id="toolbarViewerRight">
                ...
                <button id="print" class="toolbarButton hiddenMediumView" title="Imprimir" tabindex="32" data-l10n-id="print">
                  <span data-l10n-id="print_label">Imprimir</span>
                </button>
                ...
                <div id="editorModeButtons" class="splitToolbarButton toggled" role="radiogroup">
                  <button id="editorFreeText" class="hidden toolbarButton" disabled="disabled" title="Text" role="radio" aria-checked="false" tabindex="34" data-l10n-id="editor_free_text2">
              ...
              <div id="toolbarViewerMiddle">
                <div class="splitToolbarButton">
                  <button id="zoomOut" class="toolbarButton" title="Zoom Out" tabindex="21" data-l10n-id="zoom_out">
                    <span data-l10n-id="zoom_out_label">Aumentar zoom</span>
                  </button>
                  <div class="splitToolbarButtonSeparator"></div>
                  <button id="zoomIn" class="toolbarButton" title="Zoom In" tabindex="22" data-l10n-id="zoom_in">
                    <span data-l10n-id="zoom_in_label">Disminuir zoom</span>
                   </button>
                </div>
...
$_SESSION['visitado']= false;
  ...
  if ($_SESSION['user']['rol'] = 1) {
    ?>
    <script>  
      location.href="../admin/documentos.php";
    </script>
     <?php
  }  
