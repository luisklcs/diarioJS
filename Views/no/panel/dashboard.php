...
<head>
  ...
  <title>
    Panel dministrativo | Dulcería La gordy
  </title>
  <!--     Fonts and icons     -->
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                <span class="d-sm-inline d-none"><?php   # echo $_SESSION['admin']['nombre']?> nnombre de usuario </span>
              </a>
            </li>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total vendido hoy:</p>
